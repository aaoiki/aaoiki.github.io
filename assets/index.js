...
/******/ 	return __webpack_require__(__webpack_require__.s = "./static/ts/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ThemeToggler; });\nclass ThemeToggler {\n    constructor(activatorId) {\n        let el = document.getElementById(activatorId);\n        el.addEventListener(\"click\", () => this._toggle(), false);\n    }\n    keep() {\n        let isDarkThemeApplied = this._checkDarkThemeApplied();\n        if (isDarkThemeApplied) {\n            document.getElementsByTagName('body')[0].className = 'dark';\n        }\n        else {\n            document.getElementsByTagName('body')[0].className = '';\n        }\n    }\n    _toggle() {\n        let isDarkThemeApplied = !this._checkDarkThemeApplied();\n        if (isDarkThemeApplied) {\n            document.getElementsByTagName('body')[0].className = 'dark';\n        }\n        else {\n            document.getElementsByTagName('body')[0].className = '';\n        }\n        localStorage.setItem('darkTheme', JSON.stringify(isDarkThemeApplied));\n    }\n    _checkDarkThemeApplied() {\n        return JSON.parse(localStorage.getItem('darkTheme'));\n    }\n}\n\n\n//# sourceURL=webpack:///./static/ts/theme-toggler.ts?");
